...
Ou descarregar um binário pré-compilado a partir da [página de lançamento](https://github.com/venosm/swaggo/releases).
...
Encontrar o código fonte de exemplo [aqui](https://github.com/venosm/swaggo/tree/master/example/celler).
...
Encontre o resultado da formatação [aqui](https://github.com/venosm/swaggo/tree/master/example/celler).
...
[#708](https://github.com/venosm/swaggo/issues/708) O analisador trata apenas de comentários estruturais a partir de `@Description` attribute.
...
```
Para mais detalhes e outros exemplos, veja [esse arquivo](https://github.com/venosm/swaggo/blob/master/testdata/generics_nested/api/api.go)
