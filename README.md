...
[![Build Status](https://github.com/venosm/swaggo/actions/workflows/ci.yml/badge.svg?branch=master)](https://github.com/features/actions)
[![Coverage Status](https://img.shields.io/codecov/c/github/swaggo/swag/master.svg)](https://codecov.io/gh/swaggo/swag)
[![Go Report Card](https://goreportcard.com/badge/github.com/venosm/swaggo)](https://goreportcard.com/report/github.com/venosm/swaggo)
[![codebeat badge](https://codebeat.co/badges/71e2f5e5-9e6b-405d-baf9-7cc8b5037330)](https://codebeat.co/projects/github-com-swaggo-swag-master)
[![Go Doc](https://godoc.org/github.com/venosm/swaggog?status.svg)](https://godoc.org/github.com/venosm/swaggo)
[![Backers on Open Collective](https://opencollective.com/swag/backers/badge.svg)](#backers)
[![Sponsors on Open Collective](https://opencollective.com/swag/sponsors/badge.svg)](#sponsors) [![FOSSA Status](https://app.fossa.io/api/projects/git%2Bgithub.com%2Fswaggo%2Fswag.svg?type=shield)](https://app.fossa.io/projects/git%2Bgithub.com%2Fswaggo%2Fswag?ref=badge_shield)
[![Release](https://img.shields.io/github/release/swaggo/swag.svg?style=flat-square)](https://github.com/venosm/swaggo/releases)


Swag converts Go annotations to OpenAPI 3.0 Documentation. We've created a variety of plugins for popular [Go web frameworks](#supported-web-frameworks). This allows you to quickly integrate with an existing Go project (using Swagger UI).
...
Find the example source code [here](https://github.com/venosm/swaggo/tree/master/example/celler).

Finish the steps in [Getting started](#getting-started)
1. After using `swag init` to generate OpenAPI 3.0 docs, import the following packages:
```go
...
import (
    ...
    "github.com/gin-gonic/gin"
    "github.com/venosm/swaggo/example/celler/httputil"
    "github.com/venosm/swaggo/example/celler/model"
)
...
4. Run your app, and browse to http://localhost:8080/swagger/index.html. You will see OpenAPI 3.0 Api documents as shown below:
...
Find the result of formatting [here](https://github.com/venosm/swaggo/tree/master/example/celler).
...
[OpenAPI 3.0 document](https://swagger.io/docs/specification/3-0/basic-structure/)
...
**Example**
[celler/main.go](https://github.com/venosm/swaggo/blob/master/example/celler/main.go)
...
**Example**
[celler/controller](https://github.com/venosm/swaggo/tree/master/example/celler/controller)
...
[#708](https://github.com/venosm/swaggo/issues/708) The parser handles only struct comments starting with `@Description` attribute.
...
[#201](https://github.com/venosm/swaggo/issues/201#issuecomment-475479409)
...
[#379](https://github.com/venosm/swaggo/issues/379)
```go
...
```
See [this file](https://github.com/venosm/swaggo/blob/master/testdata/generics_nested/api/api.go) for more details
and other examples.

### Change the default Go Template action delimiters
[#980](https://github.com/venosm/swaggo/issues/980)
[#1177](https://github.com/venosm/swaggo/issues/1177)
...
<a href="https://github.com/venosm/swaggo/graphs/contributors"><img src="https://opencollective.com/swag/contributors.svg?width=890&button=false" /></a>
...
## Based on
This project is based on [swaggo/swag](https://github.com/venosm/swaggo) 
